...
--> Так, падажжи...
Первым запускается поток firstThread
Далее ждет завершения работы secondThread
Далее запускается secondThread

Хитро-хитро. Так можно разграничить и порядок выполнения.
*/
