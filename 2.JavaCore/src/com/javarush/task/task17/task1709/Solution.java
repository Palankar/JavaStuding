...
/* 
Предложения
-->Я точно не знаю, как это работает, однако программа начинает вести себя адекватно и упорядоченно, когда перестает
хранить переменную в локальном кэше. Ладно адекватность, но упорядоченность...
*/
