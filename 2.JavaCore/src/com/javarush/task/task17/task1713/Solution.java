...
/* 
Общий список
--> Итак, не забивай пока свою голову смыслом и делай так, как говорят. Тут главное понять, что:
    - делегировать и переопределить методы можно с помощью ALT+INSERT
    - делегироваине заклчается в вызове соответствующего метода у нужного нам объекта
    - выделить все повторяющиеся слова можно поставив на них курсов и нажав CTRL+ALT+SHIFT+J
        (ну либо поработать через галочку в CTRL+F)
*/
